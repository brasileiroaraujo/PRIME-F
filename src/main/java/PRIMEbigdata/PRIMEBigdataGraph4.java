...
//				}
		...
		}).timeWindow(Time.seconds(Integer.parseInt(args[3])), Time.seconds(Integer.parseInt(args[4]))).reduce(new ReduceFunction<ClusterGraph>() {
...
//						}
		...
		}).keyBy(0).timeWindow(Time.seconds(Integer.parseInt(args[3]))).sum(1);//.keyBy(0).sum(1);//.keyBy(0).timeWindow(Time.seconds(Integer.parseInt(args[3])), Time.seconds(Integer.parseInt(args[4]))).sum(1);//group by the tuple field "0" and sum up tuple field "1"
...
//				}
		...
		}).timeWindow(Time.seconds(Integer.parseInt(args[3])));//.timeWindow(Time.seconds(Integer.parseInt(args[3])), Time.seconds(Integer.parseInt(args[4])));//define the window;;
