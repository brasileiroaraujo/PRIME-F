...
public class FindingEntity {
	...
	public static void main(String[] args) {
		...
		try {
			...
			EntityProfile entity1 = EntityListSource.get(613);//lembre de diminuir 1 do id (lista comeca por 0)
//			System.out.println(entity1.getEntityUrl());
			...
			EntityProfile entity2 = EntityListTarget.get(625);//73-157,156,59,304,90,157,156,59,48//lembre de diminuir 1 do id (lista comeca por 0)
