...
public class FindingEntity {
	...
	public static void main(String[] args) {
		...
		try {
			...
			EntityProfile entity1 = EntityListSource.get(987);//lembre de diminuir 1 do id (lista comeca por 0)
//			System.out.println(entity1.getEntityUrl());
			...
			EntityProfile entity2 = EntityListTarget.get(2264);//831,619,829,865,776,896,946,615,642//lembre de diminuir 1 do id (lista comeca por 0)
